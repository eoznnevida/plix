...
class UserModel {
  ...
  static async create(deviceId, platformData = {}) {
    ...
    const username = `.gg/stumbleplix<color=orange><sup>#${userId}`;
  ...
  static tournaments = [
    {
      ...
      nameKey: "(.gg/sgrush) Block Dash 1v1",
    ...
    },
    {
      ...
      startTime: new Date(),
      endTime: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000),
      nameKey: "(.gg/sgrush) Block Dash Legendary 1v1",
      descriptionKey: "Practice your skills in the Stumble Rush TournamentX! mode!",
  ...
  static async getInteractions(req, res) {
    try {
      ...
      const friendProfiles = friends.map(friend => ({
        ...
        title: "(.gg.stumbleplix)secret tour",
      ...
      const friendRequestProfiles = pendingUsers.map(u => ({
        userId: u.id,
        userName: u.username,
        title: "(.gg/stumbleplix)1v1 block dash legendary",
        country: u.country,
      ...
      const recommendedProfiles = recommendedUsers.map(u => {
        ...
        return {
          ...
          userProfile: {
            userId: u.id,
            userName: u.username,
            title: "(.gg/stumbleplix)1v1 block dash",
            country: u.country,
            trophies: u.skillRating,
            crowns: u.crowns,
            experience: u.experience,
